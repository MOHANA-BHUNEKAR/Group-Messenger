...
public class GroupMessengerProvider extends ContentProvider {
	...
	private DBCreation dn=new DBCreation(getContext());
    ...
    public Uri insert(Uri uri, ContentValues values) {
		...
		long rowIdReturned = db.insertWithOnConflict(DBCreation.TABLE_NAME, null, values,SQLiteDatabase.CONFLICT_REPLACE);
		if(rowIdReturned>0){
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
    	...
    	String str="select * from "+DBCreation.TABLE_NAME+" where "+ DBCreation.COLUMN_KEY+"='"+selection+"'";
    			//SQLiteQueryBuilder query = new SQLiteQueryBuilder();
		SQLiteDatabase db = dn.getReadableDatabase();
		Cursor qc=db.rawQuery(str, null);
		
		//query.setTables(DBCreation.TABLE_NAME);
